...
const ReceiptGeneration = lazy(() => import("../pages/customclearance/ReceiptGeneration "))
const clearanceRoutes = (
  <>
    ...
    <Route path="/recipt-generate" element={<Suspense fallback={<div>Loading...</div>}><ReceiptGeneration /></Suspense>} />
  </>
);
