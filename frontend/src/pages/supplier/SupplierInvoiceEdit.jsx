          ...
          <div className="flex gap-4 items-center flex-wrap">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                value={slNoFilter}
                onChange={e => setSlNoFilter(e.target.value)}
                className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 text-sm w-24"
                placeholder="SL.No"
              />
              {slNoFilter && (
                <button className="p-1 rounded hover:bg-gray-200" onClick={() => setSlNoFilter('')}>
                  <X className="w-4 h-4 text-gray-500" />
                </button>
              )}
            </div>
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                value={invoiceNoFilter}
                onChange={e => setInvoiceNoFilter(e.target.value)}
                className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 text-sm w-36"
                placeholder="Invoice No"
              />
              {invoiceNoFilter && (
                <button className="p-1 rounded hover:bg-gray-200" onClick={() => setInvoiceNoFilter('')}>
                  <X className="w-4 h-4 text-gray-500" />
                </button>
              )}
            </div>
