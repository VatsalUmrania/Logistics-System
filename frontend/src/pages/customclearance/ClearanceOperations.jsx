...
function ClearanceOperation() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      resetForm();
      setIsAdding(false);
      setSuccessMessage(currentOperationId ? 'Operation updated successfully' : 'Operation created successfully');
      setTimeout(() => setSuccessMessage(''), 3000);
    } catch (error) {
      handleApiError(error);
    } finally {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-2">Manage and track clearance operations</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setSearchForm({...searchForm, client: e.target.value})}
              ...
              <div>
                ...
                <input
                  type="text"
                  value={searchForm.jobNo}
                  onChange={(e) => setSearchForm({...searchForm, jobNo: e.target.value})}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 text-sm"
              ...
              <div className="flex items-end">
                <button
                  onClick={() => console.log('Search:', searchForm)}
            ...
            <div className="p-4">
              ...
              <div className="mt-6 flex justify-end space-x-4">
                ...
                <button
                  ...
                  disabled={isLoading}
                >
                  {isLoading ? "Saving..." : (editingId ? "Update Operation" : "Save Operation")}
                </button>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center px-4 py-3 border-t border-gray-200 bg-gray-50">
            <div className="text-sm text-gray-700 mb-2 md:mb-0">
              ...
              {Math.min(indexOfLastItem, operations.length)} of {operations.length} operations
            </div>
            <div className="flex items-center">
