...
import { 
  ...
  ChevronLeft, ChevronRight, X, CreditCard, Eye, Download, Filter 
} from 'lucide-react';
...
const CreditNotePage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Only proceed if headers were returned (token exists)
  ...
  const totalAmount = filteredCreditNotes.reduce((sum, note) => sum + parseFloat(note.amount || 0), 0);
