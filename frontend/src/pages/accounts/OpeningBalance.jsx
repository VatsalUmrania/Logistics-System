...
//   try {
//     // ✅ Change from '/api/accounts/heads' to '/api/accounts-head'
//     const response = await axios.get(`${API_BASE_URL}/accounts-head`, getAuthHeaders());
//     if (response.data.success) {
//       // ✅ Fix data extraction - your API returns nested data
//       setAccountHeads(response.data.data.data); // Note the double .data
//     }
//   } catch (error) {
...
//       // Fetch all sub account heads
//       const response = await axios.get(`${API_BASE_URL}/sub-account-head`, getAuthHeaders());
...
//           subHead.account_head === selectedAccountHead.account_head
//         );
...
//     try {
//       setLoading(true);
//       const response = await axios.get(`${API_BASE_URL}/opening-balances`, {
//         ...getAuthHeaders(),
//         params: {
//           page: currentPage,
//           limit: itemsPerPage,
...
//     try {
//       const response = await axios.get(`${API_BASE_URL}/opening-balances/totals`, getAuthHeaders());
//       if (response.data.success) {
...
//           `${API_BASE_URL}/opening-balances/${editingId}`, 
//           data, 
//           getAuthHeaders()
//         );
...
//       const errorMessage = error.response?.data?.error || 'Failed to save Opening Balance. Please try again.';
...
//     setLoading(true);
//     try {
//       const response = await axios.delete(`${API_BASE_URL}/opening-balances/${id}`, getAuthHeaders());
...
//       const errorMessage = error.response?.data?.error || 'Failed to delete Opening Balance. Please try again.';
//       toast.error(errorMessage);
//     } finally {
//       setLoading(false);
//     }
...
//                   <p className="text-sm font-medium text-gray-600">Total Debit</p>
//                   <p className="text-2xl font-bold text-green-600">
//                     SAR {totals.total_debit.toLocaleString('en-US', { minimumFractionDigits: 2 })}
//                   </p>
//                 </div>
//                 <div className="bg-green-100 p-3 rounded-lg">
//                   <DollarSign className="w-6 h-6 text-green-600" />
...
//                   <p className="text-sm font-medium text-gray-600">Total Credit</p>
//                   <p className="text-2xl font-bold text-red-600">
//                     SAR {totals.total_credit.toLocaleString('en-US', { minimumFractionDigits: 2 })}
//                   </p>
//                 </div>
//                 <div className="bg-red-100 p-3 rounded-lg">
//                   <DollarSign className="w-6 h-6 text-red-600" />
...
//                 <div>
//                   <p className="text-sm font-medium text-gray-600">Net Balance</p>
//                   <p className={`text-2xl font-bold ${totals.net_balance >= 0 ? 'text-green-600' : 'text-red-600'}`}>
//                     SAR {Math.abs(totals.net_balance).toLocaleString('en-US', { minimumFractionDigits: 2 })}
//                   </p>
//                 </div>
//                 <div className="bg-indigo-100 p-3 rounded-lg">
//                   <Calculator className="w-6 h-6 text-indigo-600" />
