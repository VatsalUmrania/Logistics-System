...
import {
  Building2, Landmark, Plus, Pencil, Trash2, ChevronDown, Search, ChevronLeft, ChevronRight, X
} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
          <table className="min-w-full table-auto border-collapse">
            <thead className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-sm font-semibold">
              <tr>
                {[
                  ...
                  <th
                    key={label}
                    className={`px-4 py-3 text-left cursor-pointer select-none transition-all duration-200 ${
          ...
          {/* Pagination Controls */}
          <div className="flex flex-col sm:flex-row justify-between items-center px-4 py-3 border-t border-gray-100 bg-gradient-to-r from-gray-50 via-white to-purple-50">
