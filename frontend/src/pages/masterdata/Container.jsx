...
const ContainerDetailsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 py-8 px-2 md:px-8">
      <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8 border border-gray-100">
            ...
            <div className="p-6">
              ...
              <div className="flex space-x-3 pt-6">
                <button
                  onClick={handleAddContainer}
                  className="px-6 py-2.5 bg-indigo-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors flex-1 shadow-md"
                >
                  {editingId ? 'Update Container' : 'Add Container'}
                </button>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider">S.I.No.</th>
                  <th onClick={() => handleSort('name')} className="px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider cursor-pointer">
                    <div className="flex items-center">
                      Container Name
                      {sortField === 'name' && (
                        sortDirection === 'asc'
                ...
                {currentContainers.length === 0 ? (
                  <tr>
                    <td colSpan={4} className="text-center py-12 text-gray-400">
                      <Container className="w-12 h-12 mx-auto mb-4 text-blue-200" />
                      <div className="text-lg font-medium">No containers found</div>
                      <div className="text-sm mt-1">Add a new container type to get started</div>
                    </td>
                  </tr>
                ) : (
                  currentContainers.map((container, index) => (
                    <tr key={container.id} className="hover:bg-blue-50 transition">
                      <td className="px-6 py-4">{container.id}</td>
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center mr-3">
          ...
          {/* Pagination */}
          {filteredContainers.length > itemsPerPage && (
            <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between bg-gradient-to-r from-gray-50 via-white to-blue-50">
